...
const values = [
	...
	},
	{
		...
		d: 'Más de 25 años de experiencia en la construcción y la patología constructiva.',
	},
	{
		t: 'Validez pericial',
...
const differences = [
	...
	{
		t: 'Técnicos colegiados',
		d: 'Hacemos informes y dictámenes, visados cuando se requiere.',
	},
	{
...
const responsibility = [
	{
		t: 'Informes visados por el colegio',
		d: 'Cuando se requiera nuestros técnicos, entregarán un informe visado por el colegio profesional pertinente.',
	},
	{
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
					<div className="lg:col-span-7">
						...
						<p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl text-pretty">
							Ingeniería aplicada con tecnología aérea. Interpretación técnica real. Eurodrónex
							nace de la necesidad de aplicar rigor técnico profesional a la inspección de
							edificios mediante drones.
						</p>
					</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
					...
					<div className="lg:col-span-7">
						<p className="text-lg text-muted-foreground leading-relaxed">
							...
							especializados que utilizan la tecnología como herramienta. Esta diferencia
							fundamental nos permite no solo capturar imágenes, sino interpretarlas
							técnicamente, identificar patologías constructivas, evaluar riesgos estructurales
							y proponer soluciones fundamentadas en criterio profesional.
						</p>
					...
					<div className="lg:col-span-7">
						<ul className="space-y-3">
							{whatImplies.map((t) => (
								...
								>
									<span className="font-mono text-[11px] text-primary mt-1">→</span>
				...
				<div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-border border border-border">
					{responsibility.map((r) => (
						<div key={r.t} className="bg-background p-7">
							<h3 className="font-heading font-semibold text-base text-foreground">{r.t}</h3>
			...
			<section className="section-pad py-20 border-t border-border">
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
					<div className="lg:col-span-4">
						...
						<h2 className="mt-4 heading-display text-3xl text-balance">Dudas habituales</h2>
					</div>
