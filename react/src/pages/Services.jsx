...
const guide = [
	{
		...
		service: 'Informes de patologías en fachadas, cubiertas y obras',
	},
	{
			...
			<section className="section-pad pt-12 md:pt-16 pb-16 border-b border-border">
				<div className="max-w-4xl">
					...
					<p className="mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl text-pretty">
						No ofrecemos servicios aislados. Ofrecemos un ecosistema técnico integral donde cada
						inspección está respaldada por criterio ingenieril, interpretación profesional y
						validez pericial.
					</p>
				</div>
			</section>
			...
			<section className="section-pad pb-20">
				<div className="flex items-end justify-between mb-10">
					<div>
						...
						<h2 className="mt-3 heading-display text-2xl md:text-3xl">Matriz completa</h2>
					</div>
				</div>
					...
					{guide.map((g, i) => (
						...
						>
							...
							<div className="flex-1">
								...
								<p className="font-heading font-semibold text-foreground">{g.need}</p>
							</div>
			...
			<section className="section-pad py-20 border-t border-border">
				<div className="max-w-3xl">
					...
					<p className="mt-5 text-lg text-muted-foreground leading-relaxed text-pretty">
						Cualquier operador puede pilotar un dron y entregar fotografías. La diferencia está en
						saber qué significan esas imágenes, qué gravedad tiene cada lesión detectada y qué
						recomendación técnica corresponde.
					</p>
					<Link
						to="/ingenieria"
