...
export default function ProblemSolution() {
	...
	const aerial = [
		...
		'Gestionamos todos los permisos (AESA, ENAIRE)',
		...
		<section className='section-pad py-20 md:py-28 border-t border-border'>
			<div className='max-w-3xl mb-12'>
				...
				<h2 className='mt-4 heading-display text-3xl md:text-4xl lg:text-5xl text-balance'>
					Un técnico necesita estudiar una fisura, una humedad o una cubierta a
					gran altura.
				</h2>
				<p className='mt-5 text-lg text-muted-foreground leading-relaxed text-pretty'>
					Obtener esa información tradicionalmente requiere andamios,
					plataformas, permisos, personal y costes importantes solo para poder
					observar y documentar la zona. EurodroneX utiliza inspección aérea
					profesional para acercar al técnico información visual de alta
				...
				<div className='bg-foreground text-background p-8 md:p-10 relative'>
					...
					<ul className='mt-6 space-y-4'>
						{aerial.map((t) => (
							<li
								key={t}
								className='flex items-start gap-3 text-sm text-background/90'
							>
