<?php
    $pageTitle = 'Aviso legal | EurodroneX';
    $pageDescription = 'Aviso legal de EurodroneX. Datos del titular Dronspain Solutions S.L. y condiciones de uso de este sitio web.';
    $pageKeywords = 'aviso legal, EurodroneX, inspección de edificios, Madrid';
...
<html lang="es">
	...
	<body class="min-h-screen flex flex-col bg-background text-foreground antialiased">
		...
		<main id="contenido" class="flex-1 pt-20" tabindex="-1">
			<?php include_once 'components/aviso-legal-content.php'; ?>
		</main>
