...
<p class="mt-5 text-lg text-muted-foreground leading-relaxed text-pretty">Los servicios requieren comprender previamente el edificio, ubicación, alcance y necesidad técnica. Cuéntenos su caso y le asesoramos sobre el mejor enfoque técnico.</p>
...
<p class="mt-3 text-sm text-muted-foreground leading-relaxed">Operamos principalmente en la Comunidad de Madrid y provincias limítrofes. Capacidad de escalado a nivel nacional para proyectos de envergadura.</p>
<a class="mt-4 inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.16em] text-primary hover:underline" href="/contacto">Ver detalles de contacto <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-arrow-right h-3.5 w-3.5">
<path d="M5 12h14">
</path>
